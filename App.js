...
const styles = StyleSheet.create({
  ...
  notesStrip: { gap: 12, paddingTop: 4, paddingBottom: 9, paddingRight: 10 }, notePerson: { width: 94, alignItems: 'center', paddingTop: 37 }, noteBubble: { position: 'absolute', top: 0, left: 2, right: 2, minHeight: 46, borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: 9, paddingVertical: 7, justifyContent: 'center', shadowColor: '#000', shadowOpacity: .14, shadowRadius: 10, shadowOffset: { width: 0, height: 3 }, zIndex: 20, elevation: 20, overflow: 'hidden' }, noteBubbleText: { fontSize: 10.5, lineHeight: 14, fontWeight: '700', textAlign: 'center', zIndex: 21 }, noteCloseIcon: { position: 'absolute', right: 5, top: 5, zIndex: 22 }, noteAvatarWrap: { position: 'relative', zIndex: 1, elevation: 1 }, notePlus: { position: 'absolute', right: -4, bottom: -3, width: 20, height: 20, borderRadius: 10, borderWidth: 2, alignItems: 'center', justifyContent: 'center' }, noteName: { marginTop: 5, fontSize: 10, maxWidth: 90 },
